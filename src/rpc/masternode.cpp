...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Mpower address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "mpower",               "masternode",             &masternode,             true,  {} },
    { "mpower",               "masternodelist",         &masternodelist,         true,  {} },
    { "mpower",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "mpower",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "mpower",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "mpower",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
