...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Mpower related functionality
...
/*
    ...
    allow endless transaction that would bloat Mpower and make it unusable. To
