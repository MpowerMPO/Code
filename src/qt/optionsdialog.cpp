    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MPO-light"), QVariant("light"));
    ui->theme->addItem(QString("MPO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MPO-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("MPO-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("MPO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MPO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MPO-traditional"), QVariant("trad"));
