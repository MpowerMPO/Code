    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  mpower-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Mpower in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MPO, 0.1 MPO, 1 MPO and 10 MPO -- sort of like the paper money you use every day.</li> \
