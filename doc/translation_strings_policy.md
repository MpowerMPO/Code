...
This document provides guidelines for internationalization of the Mpower Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mpower_en.ts` remains unchanged.
