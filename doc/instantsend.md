...
This mechanism has been integrated into Bitcore-Node-Mpower which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mpowerpay/insight-api-mpower#web-socket-api](https://github.com/mpowerpay/insight-api-mpower#web-socket-api)
* API: [https://github.com/mpowerpay/insight-api-mpower#instantsend-transactions](https://github.com/mpowerpay/insight-api-mpower#instantsend-transactions)
...
By default, the Mpower Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mpower Core daemon:
